...
Adobe costs too much and tools like GIMP aren't similar enough to Photoshop to allow me to flow. That's why I built Compositor.

The goal is to make a full-featured Photoshop clone that is completely free and open-source. I personally use Photoshop for 2D and 3D compositing and post processing — so this tool includes all the features needed for that workflow.

Since it's open source, you can easily download the source code here and add or edit any feature to your liking and for your workflow.
